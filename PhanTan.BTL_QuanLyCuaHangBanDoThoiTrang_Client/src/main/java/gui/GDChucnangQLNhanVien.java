...
public class GDChucnangQLNhanVien extends JFrame {
	 ...
	 */
	public GDChucnangQLNhanVien() throws RemoteException {
		setResizable(false);
		...
		pNhanVien.setBackground(new Color(169, 169, 169));
		...
		pNV.setBackground(new Color(0, 255, 255));
		...
		JLabel lblNewLabel_1 = new JLabel("Chủ của hàng");
