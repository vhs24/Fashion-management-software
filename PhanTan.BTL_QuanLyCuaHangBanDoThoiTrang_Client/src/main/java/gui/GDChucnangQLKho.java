...
public class GDChucnangQLKho extends JFrame {
	 ...
	 */
	public GDChucnangQLKho() throws RemoteException {
		setResizable(false);
		...
		pKho.setBackground(new Color(169, 169, 169));
		pKho.setLayout(null);
		...
		pK = new JPanel();
		pK.setEnabled(false);
		pK.setBackground(new Color(0, 255, 255));
